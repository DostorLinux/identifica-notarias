...
$column = api_get($request, 'column');
$direction = api_get($request, 'direction');
$page = (int)api_get_number($request, 'page', 1) - 1;
$size = (int)api_get_number($request, 'size', 25);
$filter = api_get($request, 'filter');
